...
type1_rule_ids, type1_rule_confs, type2_rule_ids, type2_rule_confs = hr.grounding_rule()
    ...
    def episode(self):
        ...
        for e in range(init_epoch_id, self.max_epochs):
            ...
            with tqdm(total=len(type1_rule_ids)) as bar:
                ...
                rule1_confs = torch.tensor(type1_rule_confs).cuda()
            ...
            with tqdm(total=len(type2_rule_ids)) as bar:
                ...
                rule2_confs = torch.tensor(type2_rule_confs).cuda()
